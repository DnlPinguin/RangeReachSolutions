...
bool hybridQueryWithCubes(rTreeCubes* rTree, box spatialRegion, LocationMap* spatialGraph, int nodeDimension, int node, int* counter);
...
bool hybridQueryWithCubesReverse(vector<IntervalScheme>* interval, rTreeCubes* rTree, box spatialRegion, LocationMap* spatialGraph, int node, int* counter);
#endif