...
all:  runHybrid #createHybrid createIntervalScheme createQueries createRangeReach createSocialFirst createSpatialFirst runHybrid runQueries runRangeReach runSocialFirst runSpatialFirst
