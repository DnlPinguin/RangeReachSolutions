...
all:  createHybrid createIntervalScheme createQueries createRangeReach createSocialFirst createSpatialFirst runHybrid runQueries runRangeReach runSocialFirst runSpatialFirst
