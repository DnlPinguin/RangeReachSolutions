...
public: 
	...
	void createGVertex(Graph* socialGraph, LocationMap* locationGraph, float MAX_RMBR, float MAX_REACH_GRIDS, int layers);
	void MergeGVertex(int MERGE_COUNT);
	void createRVertex(int MAX_REACH_GRIDS, LocationMap* spatialGraph);
	void createBVertex(float MAX_RMBR, float totalSize);
